export default {
  ...
  batteryOrderIdChangeDesc: 'Bạn đang thay đổi mã đơn hàng trong khi đã có kết quả kiểm tra.',
  batteryOrderIdChangeCurrent: 'Mã đơn hiện tại',
  batteryOrderIdChangeNew: 'Mã đơn mới',
  batteryOrderIdChangeWarning: 'Lưu ý: Các kết quả đã đo sẽ vẫn giữ nguyên nhưng được gắn vào mã đơn mới.',
